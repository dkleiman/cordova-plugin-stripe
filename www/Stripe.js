...
plugin.prototype.open = function(color = this.color, statusBarColor, title = this.title, success, failure) {
	...
	if (success) {
		...
		exec(success, failure, "StripePlugin", "payments_activity", [color, statusBarColor, title, key]);
		return;
	}
	return new Promise(function(resolve, reject) {
		exec(resolve, reject, "StripePlugin", "payments_activity", [color, statusBarColor, title, key]);
	});
}
